  ...
  <div class="flex gap-8 items-center">
    <div class="flex flex-col items-center gap-4">
      <div class="bg-white flex items-center justify-center overflow-hidden">
          <img src="/assets/logos/partner_code.svg" alt="Code Logo" class="w-full h-full object-cover" />
      </div>
      <p class="text-lg text-white font-semibold">Hosting Partner</p>
    </div>
    <!-- <div class="flex flex-col items-center gap-4">
      <div class="flex items-center justify-center overflow-hidden">
          <img src="/assets/logos/partner_nauatech.jpeg" alt="Nauatech Logo" class="w-full h-full object-cover" />
      </div>
...
<div class="flex flex-col items-center justify-center h-full gap-8">
  <div class="w-150 h-full bg-white rounded-lg flex items-center justify-center overflow-hidden">
    <img src="/assets/misc/2025-07-29-nik.png" alt="QR Code for Q&A" class="w-full h-full object-cover" />
  </div>
</div>
...
<div class="absolute left-8 top-4/6 transform -translate-y-1/2">
  <img src="/assets/misc/pytorch_award.jpeg" alt="PyTorch Award" class="w-48 h-auto rounded-lg shadow-lg" />
</div>
<div class="absolute left-8 top-1/4 transform -translate-y-1/2">
  <img src="/assets/logos/osu_logo.jpg" alt="OSU Logo" class="w-48 h-auto rounded-lg shadow-lg" />
</div>
<div class="absolute right-8 top-1/2 transform -translate-y-1/2">
  <img src="/assets/logos/malaa_logo.svg" alt="Malaa Logo" class="w-48 h-auto rounded-lg shadow-lg" />
</div>
<div class="absolute right-8 top-1/4 transform -translate-y-1/2">
    <img src="/assets/logos/deepsa_logo_2.svg" alt="DeepSA Logo" class="w-full h-auto" />
</div>
<div class="absolute right-8 top-8/10 transform -translate-y-1/2">
  <img src="/assets/brand/cursor_riyadh_old.jpeg" alt="Cursor Logo" class="w-48 h-auto rounded-lg shadow-lg" />
</div>
<div class="flex flex-col items-center space-y-6 mt-8">
  <div class="w-48 h-48 bg-[#171717] border border-[#252525] rounded-full flex items-center justify-center">
    <img src="/assets/speakers/mazen_pfp.png" alt="Mazen Alotaibi" class="w-full h-full object-cover rounded-full" />
  </div>
...
<div class="absolute left-8 top-1/4 transform -translate-y-1/2">
  <img src="/assets/logos/kfupm_logo.jpeg" alt="KFUPM Logo" class="w-48 h-auto rounded-lg shadow-lg" />
</div>
<div class="absolute right-8 top-1/2 transform -translate-y-1/2">
  <img src="/assets/logos/thiqah_logo.png" alt="Thiqah Logo" class="w-48 h-auto rounded-lg shadow-lg" />
</div>
<div class="flex flex-col items-center space-y-6 mt-8">
  <div class="w-48 h-48 bg-[#171717] border border-[#252525] rounded-full flex items-center justify-center">
    <img src="/assets/speakers/faris_pfp.jpeg" alt="Faris Hijazi" class="w-full h-full object-cover rounded-full" />
  </div>
...
<div class="absolute left-2 top-5/6 transform -translate-y-1/2">
  <img src="/assets/logos/anysphere.png" alt="Anysphere Logo" class="w-32 h-auto" />
</div>
...
<div class="absolute right-8 top-5/6 transform -translate-y-1/2 flex flex-col items-center">
    <img src="/assets/brand/discord_qr_code.jpg" alt="Cursor Logo" class="w-40 h-40 transition-transform duration-300" />
...
<div class="grid grid-cols-3 gap-6 mt-8">
  ...
  <div v-click="3" class="bg-[#171717] border border-[#252525] rounded-lg p-6 text-center">
    <div class="text-3xl mb-4">🚀</div>
...
<div v-click="1" class="absolute bottom-8 right-8">
  <img src="/assets/brand/brought_to_you_by_cursor.png" alt="Brought to you by Cursor" class="w-48 h-40 rounded-full hover:scale-105 transition-transform duration-300" />
</div>
...
<div class="absolute left-8 top-5/6 transform -translate-y-1/2 flex flex-col items-center">
    <img src="/assets/brand/cursor_discord_qr_code.jpg" alt="Cursor Logo" class="w-40 h-40 transition-transform duration-300" />
